...
def leader(self, key, value):
    ...
    character_coding_scheme = {"#": "marc-8", "a": "ucs_unicode"}
    encoding_level = {
        "#": "full_level",
    ...
    return {
        ...
        "length_of_the_length_of_field_portion": length_of_the_length_of_field_portion.get(
            value[20]
        ),
        "length_of_the_starting_character_position_portion": length_of_the_starting_character_position_portion.get(
            value[21]
        ),
        "length_of_the_implementation_defined_portion": length_of_the_implementation_defined_portion.get(
            value[22]
        ),
