...
@marc21_authority.over(
    "established_heading_linking_entry_personal_name", "^700[103_][_10325476]"
)
...
@marc21_authority.over(
    "established_heading_linking_entry_corporate_name", "^710[10_2][_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_meeting_name", "^711[10_2][_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_uniform_title", "^730.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_chronological_term", "^748.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_topical_term", "^750.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_geographic_name", "^751.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_genre_form_term", "^755.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "established_heading_linking_entry_medium_of_performance_term", "^762.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "subdivision_linking_entry_general_subdivision", "^780.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "subdivision_linking_entry_geographic_subdivision", "^781.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over(
    "subdivision_linking_entry_chronological_subdivision", "^782.[_10325476]"
)
@utils.for_each_value
@utils.filter_values
...
@marc21_authority.over("subdivision_linking_entry_form_subdivision", "^785.[_10325476]")
@utils.for_each_value
@utils.filter_values
