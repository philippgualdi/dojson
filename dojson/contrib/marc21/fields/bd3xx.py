...
def physical_description(self, key, value):
    ...
    return {
        ...
        "dimensions": utils.force_list(value.get("c")),
        "extent": utils.force_list(value.get("a")),
        "other_physical_details": value.get("b"),
        "accompanying_material": value.get("e"),
        "type_of_unit": utils.force_list(value.get("f")),
        "materials_specified": value.get("3"),
        "size_of_unit": utils.force_list(value.get("g")),
        "linkage": value.get("6"),
...
def playing_time(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "playing_time": utils.force_list(value.get("a")),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
    }
...
def content_type(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "materials_specified": value.get("3"),
        "content_type_code": utils.force_list(value.get("b")),
        "content_type_term": utils.force_list(value.get("a")),
...
def media_type(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "materials_specified": value.get("3"),
        "media_type_code": utils.force_list(value.get("b")),
        "media_type_term": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def carrier_type(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "materials_specified": value.get("3"),
        "carrier_type_code": utils.force_list(value.get("b")),
        "carrier_type_term": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def physical_medium(self, key, value):
    ...
    return {
        ...
        "layout": utils.force_list(value.get("k")),
        "polarity": utils.force_list(value.get("o")),
        "production_rate_ratio": utils.force_list(value.get("f")),
        "support": utils.force_list(value.get("e")),
        "information_recording_technique": utils.force_list(value.get("d")),
        "source": value.get("2"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "font_size": utils.force_list(value.get("n")),
        "generation": utils.force_list(value.get("j")),
        "materials_applied_to_surface": utils.force_list(value.get("c")),
        "materials_specified": value.get("3"),
        "dimensions": utils.force_list(value.get("b")),
        "technical_specifications_of_medium": utils.force_list(value.get("i")),
        "material_base_and_configuration": utils.force_list(value.get("a")),
        "book_format": utils.force_list(value.get("m")),
        "linkage": value.get("6"),
        "location_within_medium": utils.force_list(value.get("h")),
    }
...
def geospatial_reference_data(self, key, value):
    ...
    return {
        ...
        "oblique_line_longitude": utils.force_list(value.get("f")),
        "standard_parallel_or_oblique_line_latitude": utils.force_list(value.get("e")),
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "azimuth_measure_point_longitude_or_straight_vertical_longitude_from_pole": value.get(
            "n"
        ),
...
def sound_characteristics(self, key, value):
    ...
    return {
        ...
        "tape_configuration": utils.force_list(value.get("f")),
        "track_configuration": utils.force_list(value.get("e")),
        "groove_characteristic": utils.force_list(value.get("d")),
        "source": value.get("2"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "configuration_of_playback_channels": utils.force_list(value.get("g")),
        "playing_speed": utils.force_list(value.get("c")),
        "materials_specified": value.get("3"),
        "recording_medium": utils.force_list(value.get("b")),
        "type_of_recording": utils.force_list(value.get("a")),
        "linkage": value.get("6"),
        "special_playback_characteristics": utils.force_list(value.get("h")),
    }
...
def projection_characteristics_of_moving_image(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "materials_specified": value.get("3"),
        "projection_speed": utils.force_list(value.get("b")),
        "presentation_format": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def video_characteristics(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "materials_specified": value.get("3"),
        "broadcast_standard": utils.force_list(value.get("b")),
        "video_format": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def digital_file_characteristics(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "file_size": utils.force_list(value.get("c")),
        "resolution": utils.force_list(value.get("d")),
        "materials_specified": value.get("3"),
        "encoding_format": utils.force_list(value.get("b")),
        "regional_encoding": utils.force_list(value.get("e")),
        "encoded_bitrate": utils.force_list(value.get("f")),
        "file_type": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def organization_and_arrangement_of_materials(self, key, value):
    ...
    return {
        ...
        "organization": utils.force_list(value.get("a")),
        "arrangement": utils.force_list(value.get("b")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
    }
...
def digital_graphic_representation(self, key, value):
    ...
    return {
        ...
        "object_count": utils.force_list(value.get("c")),
        "direct_reference_method": value.get("a"),
        "object_type": utils.force_list(value.get("b")),
...
def security_classification_control(self, key, value):
    ...
    return {
        ...
        "authorization": utils.force_list(value.get("j")),
        "external_dissemination_information": utils.force_list(value.get("c")),
        "security_classification": value.get("a"),
        "handling_instructions": utils.force_list(value.get("b")),
...
def originator_dissemination_control(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "authorized_recipients_of_material": utils.force_list(value.get("c")),
        "originator_control_term": value.get("a"),
        "originating_agency": utils.force_list(value.get("b")),
        "other_restrictions": utils.force_list(value.get("g")),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
    }
...
def associated_language(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "language_code": utils.force_list(value.get("a")),
        "source": value.get("2"),
        "linkage": value.get("6"),
        "language_term": utils.force_list(value.get("l")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "source_of_code": value.get("2")
        if key[4] == "7"
        else indicator_map2.get(key[4]),
    }
...
def form_of_work(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "form_of_work": utils.force_list(value.get("a")),
...
def other_distinguishing_characteristics_of_work_or_expression(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "other_distinguishing_characteristic": utils.force_list(value.get("a")),
        "source_of_information": utils.force_list(value.get("v")),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
        "record_control_number": utils.force_list(value.get("0")),
        "source_of_term": value.get("2"),
...
def medium_of_performance(self, key, value):
    ...
    return {
        ...
        "note": utils.force_list(value.get("v")),
        "total_number_of_performers": value.get("s"),
        "number_of_ensembles_of_the_same_type": utils.force_list(value.get("e")),
        "doubling_instrument": utils.force_list(value.get("d")),
        "source_of_term": value.get("2"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "number_of_performers_of_the_same_medium": utils.force_list(value.get("n")),
        "total_number_of_individuals_performing_alongside_ensembles": value.get("r"),
        "total_number_of_ensembles": value.get("t"),
        "medium_of_performance": utils.force_list(value.get("a")),
        "soloist": utils.force_list(value.get("b")),
        "alternative_medium_of_performance": utils.force_list(value.get("p")),
        "linkage": value.get("6"),
        "display_constant_controller": indicator_map1.get(key[3]),
...
def numeric_designation_of_musical_work(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "thematic_index_number": utils.force_list(value.get("c")),
        "serial_number": utils.force_list(value.get("a")),
        "opus_number": utils.force_list(value.get("b")),
...
def audience_characteristics(self, key, value):
    ...
    return {
        ...
        "materials_specified": value.get("3"),
        "audience_code": utils.force_list(value.get("b")),
        "audience_term": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
...
def creator_contributor_characteristics(self, key, value):
    ...
    return {
        ...
        "demographic_group_code": value.get("n"),
        "materials_specified": value.get("3"),
        "creator_contributor_code": utils.force_list(value.get("b")),
        "creator_contributor_term": utils.force_list(value.get("a")),
        "authority_record_control_number_or_standard_number": utils.force_list(
            value.get("0")
        ),
        "source": value.get("2"),
