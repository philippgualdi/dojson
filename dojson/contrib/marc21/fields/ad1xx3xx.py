...
def complex_see_also_reference_subject(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "heading_referred_to": utils.force_list(value.get("a")),
        "authority_record_control_number": utils.force_list(value.get("0")),
        "explanatory_text": utils.force_list(value.get("i")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "linkage": value.get("6"),
    }
...
def other_attributes_of_person_or_corporate_body(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "type_of_corporate_body": utils.force_list(value.get("a")),
        "other_designation": utils.force_list(value.get("c")),
        "type_of_jurisdiction": utils.force_list(value.get("b")),
        "title_of_person": utils.force_list(value.get("d")),
...
def associated_place(self, key, value):
    ...
    return {
        ...
        "place_of_residence_headquarters": utils.force_list(value.get("e")),
...
def address(self, key, value):
    ...
    return {
        ...
        "country": value.get("d"),
        "source_of_information": utils.force_list(value.get("v")),
        "electronic_mail_address": utils.force_list(value.get("m")),
        "start_period": value.get("s"),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
...
def field_of_activity(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "field_of_activity": utils.force_list(value.get("a")),
        "source_of_information": utils.force_list(value.get("v")),
        "record_control_number": utils.force_list(value.get("0")),
        "start_period": value.get("s"),
        "source_of_term": value.get("2"),
...
def associated_group(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "associated_group": utils.force_list(value.get("a")),
        "source_of_information": utils.force_list(value.get("v")),
        "record_control_number": utils.force_list(value.get("0")),
        "start_period": value.get("s"),
        "source_of_term": value.get("2"),
...
def occupation(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "occupation": utils.force_list(value.get("a")),
        "source_of_information": utils.force_list(value.get("v")),
        "record_control_number": utils.force_list(value.get("0")),
        "start_period": value.get("s"),
        "source_of_term": value.get("2"),
...
def gender(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "gender": utils.force_list(value.get("a")),
        "source_of_information": utils.force_list(value.get("v")),
        "start_period": value.get("s"),
        "source_of_term": value.get("2"),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
...
def family_information(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "type_of_family": utils.force_list(value.get("a")),
        "hereditary_title": utils.force_list(value.get("c")),
        "name_of_prominent_member": utils.force_list(value.get("b")),
        "source_of_information": utils.force_list(value.get("v")),
        "record_control_number": utils.force_list(value.get("0")),
        "start_period": value.get("s"),
        "source_of_term": value.get("2"),
