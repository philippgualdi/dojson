...
@marc21_authority.over(
    "link_to_bibliographic_record_for_serial_or_multipart_item", "^014.."
)
...
def national_bibliographic_agency_control_number(self, key, value):
    ...
    return {
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "source": value.get("2"),
        "canceled_or_invalid_record_control_number": utils.force_list(value.get("z")),
        "national_bibliographic_agency": value.get("2")
        if key[3] == "7"
        else "Library and Archives Canada",
    }
...
def other_standard_identifier(self, key, value):
    ...
    return {
        ...
        "type_of_standard_number_or_code": value.get("2")
        if key[3] == "7"
...
def coded_cartographic_mathematical_data(self, key, value):
    ...
    indicator_map2 = {"_": "Not applicable", "0": "Outer ring", "1": "Exclusion ring"}
...
def system_control_number(self, key, value):
    ...
    return {
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "canceled_invalid_system_control_number": utils.force_list(value.get("z")),
        "linkage": value.get("6"),
    }
...
def lc_classification_number(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "classification_number_element_single_number_or_beginning_number_of_span": value.get(
            "a"
        ),
...
def other_classification_number(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "classification_number_element_single_number_or_beginning_of_span": value.get(
            "a"
        ),
        "explanatory_term": value.get("c"),
        "classification_number_element_ending_number_of_span": value.get("b"),
...
def subject_category_code(self, key, value):
    ...
    return {
        ...
        if key[4] == "7"
        else indicator_map2.get(key[4], "No information provided"),
    }
...
def subdivision_usage(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "subdivision_usage": utils.force_list(value.get("a")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
...
@marc21_authority.over("dewey_decimal_classification_number", "^083[10_7][0_4]")
@utils.for_each_value
@utils.filter_values
...
def government_document_call_number(self, key, value):
    ...
    return {
        ...
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "canceled_invalid_call_number": utils.force_list(value.get("z")),
...
def government_document_classification_number(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "classification_number_element_single_number_of_beginning_number_of_span": value.get(
            "a"
        ),
        ...
        "linkage": value.get("6"),
        "number_source": value.get("2")
        if key[3] not in indicator_map1
        else indicator_map1.get(key[3]),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
    }
