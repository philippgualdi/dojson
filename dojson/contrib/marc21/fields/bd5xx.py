...
def dissertation_note(self, key, value):
    ...
    return {
        ...
        "dissertation_identifier": utils.force_list(value.get("o")),
        "linkage": value.get("6"),
...
def formatted_contents_note(self, key, value):
    ...
    return {
        ...
        "statement_of_responsibility": utils.force_list(value.get("r")),
...
def restrictions_on_access_note(self, key, value):
    ...
    return {
        ...
        "authorization": utils.force_list(value.get("e")),
        "institution_to_which_field_applies": value.get("5"),
        "physical_access_provisions": utils.force_list(value.get("c")),
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "materials_specified": value.get("3"),
        "jurisdiction": utils.force_list(value.get("b")),
        "authorized_users": utils.force_list(value.get("d")),
...
def data_quality_note(self, key, value):
    ...
    return {
        ...
        "display_note": utils.force_list(value.get("z")),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
        "cloud_cover": value.get("m"),
        "horizontal_position_accuracy_value": utils.force_list(value.get("g")),
        "completeness_report": value.get("e"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "vertical_positional_accuracy_report": value.get("i"),
        "attribute_accuracy_explanation": utils.force_list(value.get("c")),
        "horizontal_position_accuracy_report": value.get("f"),
        "linkage": value.get("6"),
        "attribute_accuracy_value": utils.force_list(value.get("b")),
        "logical_consistency_report": value.get("d"),
        "horizontal_position_accuracy_explanation": utils.force_list(value.get("h")),
        "vertical_positional_accuracy_value": utils.force_list(value.get("j")),
        "vertical_positional_accuracy_explanation": utils.force_list(value.get("k")),
    }
...
def date_time_and_place_of_an_event_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "record_control_number": utils.force_list(value.get("0")),
        "date_time_and_place_of_an_event_note": value.get("a"),
        "place_of_event": utils.force_list(value.get("p")),
        "other_event_information": utils.force_list(value.get("o")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "source_of_term": utils.force_list(value.get("2")),
        "date_of_event": utils.force_list(value.get("d")),
    }
...
def target_audience_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "target_audience_note": utils.force_list(value.get("a")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "source": value.get("b"),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
...
def reproduction_note(self, key, value):
    ...
    return {
        ...
        "note_about_reproduction": utils.force_list(value.get("n")),
        "agency_responsible_for_reproduction": utils.force_list(value.get("c")),
        "series_statement_of_reproduction": utils.force_list(value.get("f")),
        "linkage": value.get("6"),
        "institution_to_which_field_applies": value.get("5"),
        "dates_and_or_sequential_designation_of_issues_reproduced": utils.force_list(
            value.get("m")
        ),
        "place_of_reproduction": utils.force_list(value.get("b")),
...
def original_version_note(self, key, value):
    ...
    return {
        ...
        "other_resource_identifier": utils.force_list(value.get("o")),
        "materials_specified": value.get("3"),
        "international_standard_serial_number": utils.force_list(value.get("x")),
        "physical_description_of_original": value.get("e"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "note_about_original": utils.force_list(value.get("n")),
        "title_statement_of_original": value.get("t"),
        "publication_distribution_of_original": value.get("c"),
        "series_statement_of_original": utils.force_list(value.get("f")),
        "linkage": value.get("6"),
        ...
        "key_title_of_original": utils.force_list(value.get("k")),
    }
...
def location_of_originals_duplicates_note(self, key, value):
    ...
    return {
        ...
        "country": utils.force_list(value.get("c")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "postal_address": utils.force_list(value.get("b")),
        "telecommunications_address": utils.force_list(value.get("d")),
...
def funding_information_note(self, key, value):
    ...
    return {
        ...
        "program_element_number": utils.force_list(value.get("e")),
        "project_number": utils.force_list(value.get("f")),
        "linkage": value.get("6"),
        "task_number": utils.force_list(value.get("g")),
        "grant_number": utils.force_list(value.get("c")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "contract_number": utils.force_list(value.get("b")),
        "undifferentiated_number": utils.force_list(value.get("d")),
        "work_unit_number": utils.force_list(value.get("h")),
    }
...
def immediate_source_of_acquisition_note(self, key, value):
    ...
    return {
        ...
        "type_of_unit": utils.force_list(value.get("o")),
        "materials_specified": value.get("3"),
        "accession_number": value.get("e"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "extent": utils.force_list(value.get("n")),
...
def location_of_other_archival_materials_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "custodian": utils.force_list(value.get("a")),
        "provenance": utils.force_list(value.get("e")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "country": utils.force_list(value.get("c")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "address": utils.force_list(value.get("b")),
        "title": utils.force_list(value.get("d")),
        "note": utils.force_list(value.get("n")),
...
def language_note(self, key, value):
    ...
    return {
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "information_code_or_alphabet": utils.force_list(value.get("b")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
    }
...
def entity_and_attribute_information_note(self, key, value):
    ...
    return {
        ...
        "entity_and_attribute_detail_citation": utils.force_list(value.get("p")),
        "entity_and_attribute_overview": utils.force_list(value.get("o")),
        "attribute_value_accuracy_explanation": value.get("m"),
        "range_domain_minimum_and_maximum": value.get("g"),
        "enumerated_domain_value": utils.force_list(value.get("e")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
...
def cumulative_index_finding_aids_note(self, key, value):
    ...
    return {
        ...
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "availability_source": utils.force_list(value.get("b")),
...
def copy_and_version_identification_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "identifying_markings": utils.force_list(value.get("a")),
        "number_of_copies": utils.force_list(value.get("e")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "version_identification": utils.force_list(value.get("c")),
        "institution_to_which_field_applies": value.get("5"),
        "copy_identification": utils.force_list(value.get("b")),
        "presentation_format": utils.force_list(value.get("d")),
    }
...
def case_file_characteristics_note(self, key, value):
    ...
    return {
        ...
        "filing_scheme_or_code": utils.force_list(value.get("e")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "unit_of_analysis": utils.force_list(value.get("c")),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "name_of_variable": utils.force_list(value.get("b")),
        "universe_of_data": utils.force_list(value.get("d")),
        "display_constant_controller": indicator_map1.get(key[3]),
    }
...
def action_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "action": value.get("a"),
        "status": utils.force_list(value.get("l")),
        "public_note": utils.force_list(value.get("z")),
        "type_of_unit": utils.force_list(value.get("o")),
        "source_of_term": value.get("2"),
        "nonpublic_note": utils.force_list(value.get("x")),
        "contingency_for_action": utils.force_list(value.get("e")),
        "institution_to_which_field_applies": value.get("5"),
        "extent": utils.force_list(value.get("n")),
        "method_of_action": utils.force_list(value.get("i")),
        "time_date_of_action": utils.force_list(value.get("c")),
        "authorization": utils.force_list(value.get("f")),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
        "materials_specified": value.get("3"),
        "action_identification": utils.force_list(value.get("b")),
        "action_interval": utils.force_list(value.get("d")),
        "jurisdiction": utils.force_list(value.get("h")),
        "site_of_action": utils.force_list(value.get("j")),
        "action_agent": utils.force_list(value.get("k")),
        "privacy": indicator_map1.get(key[3]),
    }
...
def accumulation_and_frequency_of_use_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "accumulation": utils.force_list(value.get("a")),
        "materials_specified": value.get("3"),
        "linkage": value.get("6"),
        "field_link_and_sequence_number": utils.force_list(value.get("8")),
        "institution_to_which_field_applies": value.get("5"),
        "frequency_of_use": utils.force_list(value.get("b")),
    }
