...
def location(self, key, value):
    ...
    return {
        ...
        "shelving_location": utils.force_list(value.get("c")),
        "sublocation_or_collection": utils.force_list(value.get("b")),
        "address": utils.force_list(value.get("e")),
        "former_shelving_location": utils.force_list(value.get("d")),
        "non_coded_location_qualifier": utils.force_list(value.get("g")),
        "coded_location_qualifier_\n": utils.force_list(value.get("f")),
        "item_part": utils.force_list(value.get("i")),
        "classification_part": value.get("h"),
        "call_number_prefix": utils.force_list(value.get("k")),
        "shelving_control_number": value.get("j"),
        "call_number_suffix": utils.force_list(value.get("m")),
        ...
        "copyright_article_fee_code": utils.force_list(value.get("s")),
...
@marc21_holdings.over("captions_and_pattern_basic_bibliographic_unit", "^853..")
@utils.for_each_value
@utils.filter_values
...
def electronic_location_and_access(self, key, value):
    ...
    return {
        ...
        "host_name": utils.force_list(value.get("a")),
        "compression_information": utils.force_list(value.get("c")),
        "access_number": utils.force_list(value.get("b")),
        "path": utils.force_list(value.get("d")),
        "electronic_name": utils.force_list(value.get("f")),
        "instruction": utils.force_list(value.get("i")),
        "processor_of_request": value.get("h"),
        "password": value.get("k"),
        "bits_per_second": value.get("j"),
        "contact_for_access_assistance": utils.force_list(value.get("m")),
        "logon": value.get("l"),
        "operating_system": value.get("o"),
        "name_of_location_of_host": value.get("n"),
        "electronic_format_type": value.get("q"),
        "port": value.get("p"),
        "file_size": utils.force_list(value.get("s")),
        "settings": value.get("r"),
        "uniform_resource_identifier": utils.force_list(value.get("u")),
        "terminal_emulation": utils.force_list(value.get("t")),
        "record_control_number": utils.force_list(value.get("w")),
        "hours_access_method_available": utils.force_list(value.get("v")),
...
@marc21_holdings.over("enumeration_and_chronology_basic_bibliographic_unit", "^863..")
@utils.for_each_value
@utils.filter_values
...
@marc21_holdings.over("enumeration_and_chronology_supplementary_material", "^864..")
@utils.for_each_value
@utils.filter_values
...
def alternate_graphic_representation(self, key, value):
    ...
    return {
        "same_as_associated_field": utils.force_list(value.get("1")),
        "same_as_associated_field": utils.force_list(value.get("0")),
        "same_as_associated_field": utils.force_list(value.get("3")),
        "same_as_associated_field": utils.force_list(value.get("2")),
        "same_as_associated_field": utils.force_list(value.get("5")),
        "same_as_associated_field": utils.force_list(value.get("4")),
        "same_as_associated_field": utils.force_list(value.get("7")),
        "linkage": value.get("6"),
        "same_as_associated_field": utils.force_list(value.get("9")),
        "same_as_associated_field": utils.force_list(value.get("8")),
        "same_as_associated_field": utils.force_list(value.get("a")),
        "same_as_associated_field": utils.force_list(value.get("c")),
        "same_as_associated_field": utils.force_list(value.get("b")),
        "same_as_associated_field": utils.force_list(value.get("e")),
        "same_as_associated_field": utils.force_list(value.get("d")),
        "same_as_associated_field": utils.force_list(value.get("g")),
        "same_as_associated_field": utils.force_list(value.get("f")),
        "same_as_associated_field": utils.force_list(value.get("i")),
        "same_as_associated_field": utils.force_list(value.get("h")),
        "same_as_associated_field": utils.force_list(value.get("k")),
        "same_as_associated_field": utils.force_list(value.get("j")),
        "same_as_associated_field": utils.force_list(value.get("m")),
        "same_as_associated_field": utils.force_list(value.get("l")),
        "same_as_associated_field": utils.force_list(value.get("o")),
        "same_as_associated_field": utils.force_list(value.get("n")),
        "same_as_associated_field": utils.force_list(value.get("q")),
        "same_as_associated_field": utils.force_list(value.get("p")),
        "same_as_associated_field": utils.force_list(value.get("s")),
        "same_as_associated_field": utils.force_list(value.get("r")),
        "same_as_associated_field": utils.force_list(value.get("u")),
        "same_as_associated_field": utils.force_list(value.get("t")),
        "same_as_associated_field": utils.force_list(value.get("w")),
        "same_as_associated_field": utils.force_list(value.get("v")),
        "same_as_associated_field": utils.force_list(value.get("y")),
        "same_as_associated_field": utils.force_list(value.get("x")),
        "same_as_associated_field": utils.force_list(value.get("z")),
    }
