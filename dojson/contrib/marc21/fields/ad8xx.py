...
def alternate_graphic_representation(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "same_as_associated_field_1": utils.force_list(value.get("1")),
        "same_as_associated_field_0": utils.force_list(value.get("0")),
        "same_as_associated_field_3": utils.force_list(value.get("3")),
        "same_as_associated_field_2": utils.force_list(value.get("2")),
        "same_as_associated_field_5": utils.force_list(value.get("5")),
        "same_as_associated_field_4": utils.force_list(value.get("4")),
        "same_as_associated_field_7": utils.force_list(value.get("7")),
        "linkage": value.get("6"),
        "same_as_associated_field_9": utils.force_list(value.get("9")),
        "same_as_associated_field_8": utils.force_list(value.get("8")),
        "same_as_associated_field_a": utils.force_list(value.get("a")),
        "same_as_associated_field_c": utils.force_list(value.get("c")),
        "same_as_associated_field_b": utils.force_list(value.get("b")),
        "same_as_associated_field_e": utils.force_list(value.get("e")),
        "same_as_associated_field_d": utils.force_list(value.get("d")),
        "same_as_associated_field_g": utils.force_list(value.get("g")),
        "same_as_associated_field_f": utils.force_list(value.get("f")),
        "same_as_associated_field_i": utils.force_list(value.get("i")),
        "same_as_associated_field_h": utils.force_list(value.get("h")),
        "same_as_associated_field_k": utils.force_list(value.get("k")),
        "same_as_associated_field_j": utils.force_list(value.get("j")),
        "same_as_associated_field_m": utils.force_list(value.get("m")),
        "same_as_associated_field_l": utils.force_list(value.get("l")),
        "same_as_associated_field_o": utils.force_list(value.get("o")),
        "same_as_associated_field_n": utils.force_list(value.get("n")),
        "same_as_associated_field_q": utils.force_list(value.get("q")),
        "same_as_associated_field_p": utils.force_list(value.get("p")),
        "same_as_associated_field_s": utils.force_list(value.get("s")),
        "same_as_associated_field_r": utils.force_list(value.get("r")),
        "same_as_associated_field_u": utils.force_list(value.get("u")),
        "same_as_associated_field_t": utils.force_list(value.get("t")),
        "same_as_associated_field_w": utils.force_list(value.get("w")),
        "same_as_associated_field_v": utils.force_list(value.get("v")),
        "same_as_associated_field_y": utils.force_list(value.get("y")),
        "same_as_associated_field_x": utils.force_list(value.get("x")),
        "same_as_associated_field_z": utils.force_list(value.get("z")),
        "ind1": key[3],
        "ind2": key[4],
    }
