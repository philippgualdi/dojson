...
def reverse_complex_see_also_reference_subject(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("heading_referred_to")),
...
def reverse_other_attributes_of_person_or_corporate_body(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("type_of_corporate_body")),
        "c": utils.reverse_force_list(value.get("other_designation")),
        "b": utils.reverse_force_list(value.get("type_of_jurisdiction")),
        "d": utils.reverse_force_list(value.get("title_of_person")),
...
def reverse_associated_place(self, key, value):
    ...
    return {
        ...
        "e": utils.reverse_force_list(value.get("place_of_residence_headquarters")),
...
def reverse_field_of_activity(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("field_of_activity")),
        "v": utils.reverse_force_list(value.get("source_of_information")),
        "0": utils.reverse_force_list(value.get("record_control_number")),
        "s": value.get("start_period"),
        "2": value.get("source_of_term"),
...
def reverse_associated_group(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("associated_group")),
        "v": utils.reverse_force_list(value.get("source_of_information")),
        "0": utils.reverse_force_list(value.get("record_control_number")),
        "s": value.get("start_period"),
        "2": value.get("source_of_term"),
...
def reverse_gender(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("gender")),
        "v": utils.reverse_force_list(value.get("source_of_information")),
        "s": value.get("start_period"),
        "2": value.get("source_of_term"),
        "u": utils.reverse_force_list(value.get("uniform_resource_identifier")),
...
def reverse_family_information(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("type_of_family")),
        "c": utils.reverse_force_list(value.get("hereditary_title")),
        "b": utils.reverse_force_list(value.get("name_of_prominent_member")),
        "v": utils.reverse_force_list(value.get("source_of_information")),
        "0": utils.reverse_force_list(value.get("record_control_number")),
        "s": value.get("start_period"),
        "2": value.get("source_of_term"),
