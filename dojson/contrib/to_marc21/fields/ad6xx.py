...
def reverse_series_place_and_publisher_issuing_body(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("place")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "b": utils.reverse_force_list(value.get("publisher_issuing_body")),
...
def reverse_complex_see_also_reference_name(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("explanatory_text")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "b": utils.reverse_force_list(value.get("heading_referred_to")),
        "t": utils.reverse_force_list(value.get("title_referred_to")),
        "6": value.get("linkage"),
        "$ind1": "_",
        "$ind2": "_",
    }
...
def reverse_history_reference(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("history_reference")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "6": value.get("linkage"),
        "$ind1": "_",
        "$ind2": "_",
...
def reverse_general_explanatory_reference_name(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("general_explanatory_reference")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "6": value.get("linkage"),
        "$ind1": "_",
        "$ind2": "_",
...
def reverse_source_data_not_found(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("source_citation")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "6": value.get("linkage"),
        "$ind1": "_",
        "$ind2": "_",
...
def reverse_public_general_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("heading_or_subdivision_term")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "5": utils.reverse_force_list(value.get("institution_to_which_field_applies")),
...
def reverse_subject_example_tracing_note(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("subject_heading_or_subdivision_term")),
        "8": utils.reverse_force_list(value.get("field_link_and_sequence_number")),
        "i": utils.reverse_force_list(value.get("explanatory_text")),
        "6": value.get("linkage"),
        "$ind1": "_",
...
def reverse_deleted_heading_information(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "a": utils.reverse_force_list(value.get("replacement_heading")),
        "0": utils.reverse_force_list(
