...
def reverse_subject_added_entry_personal_name(self, key, value):
    ...
    if indicator_map1.get(value.get("type_of_personal_name_entry_element"), "7") != "7":
        try:
    ...
    return {
        ...
        "$ind1": indicator_map1.get(
            value.get("type_of_personal_name_entry_element"), "_"
        ),
        "$ind2": "7"
        if "thesaurus" in value
        and not indicator_map2.get(value.get("thesaurus"))
        and value.get("thesaurus") == value.get("source_of_heading_or_term")
...
def reverse_subject_added_entry_corporate_name(self, key, value):
    ...
    if (
        indicator_map1.get(value.get("type_of_corporate_name_entry_element"), "7")
        != "7"
    ):
        try:
...
def reverse_subject_added_entry_meeting_name(self, key, value):
    ...
    if indicator_map1.get(value.get("type_of_meeting_name_entry_element"), "7") != "7":
        try:
    ...
    return {
        ...
        "$ind1": indicator_map1.get(
            value.get("type_of_meeting_name_entry_element"), "_"
        ),
        "$ind2": "7"
        if "thesaurus" in value
        and not indicator_map2.get(value.get("thesaurus"))
...
def reverse_index_term_genre_form(self, key, value):
    ...
    return {
        ...
        if "thesaurus" in value
        and not indicator_map2.get(value.get("thesaurus"))
        and value.get("thesaurus") == value.get("source_of_term")
        else indicator_map2.get(value.get("thesaurus"), "_"),
    }
...
def reverse_index_term_occupation(self, key, value):
    ...
    return {
        ...
        "$ind1": "_",
        "$ind2": "7"
        if "source_of_term" in value
        and not indicator_map2.get(value.get("source_of_term"))
        and value.get("source_of_term") == value.get("source_of_term")
